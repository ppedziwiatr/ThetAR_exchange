  ...
  // src/mintable/actions/common.ts
  var isAddress = (addr) => /[a-z0-9_-]{43}/i.test(addr);

  // src/mintable/actions/read/balance.ts
  ...
  // src/mintable/actions/write/transferTokens.ts
  ...
  // src/mintable/actions/write/mint.ts
  var mint = async (state, { caller, input: { qty } }) => {
    qty = Math.floor(qty);
